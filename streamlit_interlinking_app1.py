# -*- coding: utf-8 -*-
"""
Created on Thu Mar  9 08:29:05 2023

@author: https://github.com/searchsolved/search-solved-public-seo/blob/main/bert_interlinker/bert_semantic_interlinker.py
"""
...
if uploaded_file is not None:
    ...
    try:
        ...
        df.rename(columns={"url": "URL", "dates": "Dates", "Title": "Title","sentiment": "Sentiment", "category": "Category"}, inplace=True)
